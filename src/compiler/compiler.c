...
int Compiler_compile(Context* context, Node* node)
{
  ...
  switch (node->tag) {
    case BranchNode:
      return Compiler_compileBranchNode(context, node);
    case BinOpNode:
      return Compiler_compileBinOpNode(context, node);
    case UnOpNode:
      return Compiler_compileUnOpNode(context, node);
    case CallNode:
      return Compiler_compileCallNode(context, node);
    case SendNode:
      return Compiler_compileSendNode(context, node);
    case DoNode:
      return Compiler_compileDoNode(context, node);
    case ArgsNode:
      return Compiler_compileArgsNode(context, node);
    case SetSlotNode:
      return Compiler_compileSetSlotNode(context, node);
    case GetSlotNode:
      return Compiler_compileGetSlotNode(context, node);
    case AssignNode:
      return Compiler_compileAssignNode(context, node);
    case SubscriptNode:
      return Compiler_compileSubscriptNode(context, node);
    case IfNode:
      return Compiler_compileIfNode(context, node);
    case WhileNode:
      return Compiler_compileWhileNode(context, node);
    case TryNode:
      return Compiler_compileTryNode(context, node);
    case ListNode:
      return Compiler_compileListNode(context, node);
    case HashNode:
      return Compiler_compileHashNode(context, node);
    case HashArgsNode:
      return Compiler_compileHashArgsNode(context, node);
    case IntegerNode:
      return Compiler_compileIntegerNode(context, node);
    case FloatNode:
      return Compiler_compileFloatNode(context, node);
    case StringNode:
      return Compiler_compileStringNode(context, node);
    case NameNode:
      return Compiler_compileNameNode(context, node);
    case SymbolNode:
      return Compiler_compileSymbolNode(context, node);
    default:
      abort();
      return 0;
  }
